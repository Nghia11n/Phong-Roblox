...
local Tabs = {
    ...
    AR = Window:AddTab({ Title = "Anime Reborn", Icon = "" })
    ...
    TTD = Window:AddTab({ Title = "Toilet Tower Defense", Icon = "" })
    SR = Window:AddTab({ Title = "Sol Rng", Icon = "" })
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/ChopLoris
    end
})
